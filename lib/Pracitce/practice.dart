      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(
                              ...
                              // : selectedIndex == 8 ? _start6.toString()
                                  : _start6.toString(),
                              style: TextStyle(
            ...
            SizedBox(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  // double progress = progressList[index];

                  return selectedIndex == 1 ? index == 0 ? SizedBox(width: 50.w)
                      : custom_indicator(
                    trophy: trophy1,
                    percent: timerValue
                    ...
                    selectedIndex == 2 ? index == 1 ? SizedBox(width: 45.w,) : custom_indicator(
                      trophy: trophy2,
                      percent:
                           timerValue1
                      ):

                    selectedIndex == 3 ? index == 2 ? SizedBox(width: 45.w,) : custom_indicator(
                      trophy: trophy3,
                      percent: timerValue2
                     ):

                    selectedIndex == 4 ? index == 3 ? SizedBox(width: 45.w,) : custom_indicator(
                      trophy: trophy4,
                      percent: timerValue3
                      ):
                    ...
                    selectedIndex == 8 ? index == 7 ? SizedBox(width: 45.w,) : custom_indicator(
                        trophy: trophy7,
                        percent: timerValue6,
            ...
            // Image.asset('assets/images/trophy.gif',height: 100,width: 80,),
