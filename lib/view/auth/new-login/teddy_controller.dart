...
class TeddyController extends FlareControls {
  ...
  bool advance(FlutterActorArtboard artboard, double elapsed) {
    ...
    if (_hasFocus) {
      ...
      targetTranslation = _faceOriginLocal;
    }
    ...
    if (targetTranslation != null) {
      ...
      Vec2D frameTranslation = Vec2D.add(
          Vec2D(), _faceControl!.translation, Vec2D.scale(diff, diff, min(1.0, elapsed * 5.0)));
  ...
  void initialize(FlutterActorArtboard artboard) {
    ...
    _faceControl = artboard.getNode("ctrl_face") as ActorNode?;
    if (_faceControl != null) {
